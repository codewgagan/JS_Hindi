...
*/
/*
const newArr = myArr.join()//this method converts object into string means type of myArr is object and tyoe fo newArr is string.
console.log(myArr);
...
const myArr2 = myArr.splice(1,3) //manipulates the original array and changes the elements of an oriiginal array
console.log("C", myArr)
console.log(myArr)
